...
// 103-region version
// Checkpoint: saves to checkpoints/{agent_name}.pt
//   When agent is "alice103" (vesna_navigation_rl_103.jcm):
//     -> checkpoints/alice103.pt
// Training script: start_training_100.sh
// Log file: logs/dqn_server_103.log
// ============================================================

{ include("playgrounds/office/office_map_103.asl") }
{ include("bridge_103.asl") }


//------------------------------CONFIGURATION (100 regions)-------------

max_steps(250).                 // max steps before timeout
max_episodes(500000).           // 500K episodes
eval_mode(false).               // false = train from scratch
save_interval(10000).           // auto-save every 10K episodes
