...
public class TraceEntry {
  ...
  public String getChangerContent() {
    return changerContent;
  }
  ...
  public String getContextEvaluated() {
    return contextEvaluated;
  }

  public List<String> getAlternativesNotSelected() {
    return new ArrayList<>(alternativesNotSelected);
  }

  public List<String> getBeliefsSnapshot() {
    return new ArrayList<>(beliefsSnapshot);
  }

  public List<String> getIntentionsSnapshot() {
    return new ArrayList<>(intentionsSnapshot);
  }

  public List<String> getEventsSnapshot() {
    return new ArrayList<>(eventsSnapshot);
  }
